 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://v7001.api.service.ccollab.smartbear.com/}actionItem" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetActionItemsResponse {
    ...
    protected List<ActionItem> _return;
     ...
     * {@link ActionItem }
     */
    public List<ActionItem> getReturn() {
        if (_return == null) {
            _return = new ArrayList<ActionItem>();
        }
        return this._return;
    }
